...
public abstract class AbstractBrush implements Brush {
    ...
    public void setBlockType(BlockVector3 position, BlockType type) throws MaxChangedBlocksException {
        int x = position.getX();
        int y = position.getY();
        int z = position.getZ();
    ...
    public void setBlockType(int x, int y, int z, BlockType type) throws MaxChangedBlocksException {
