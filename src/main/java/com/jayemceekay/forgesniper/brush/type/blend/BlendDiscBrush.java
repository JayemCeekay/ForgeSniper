    ...
    public void handleCommand(String[] parameters, Snipe snipe) {
        ...
        for(int var6 = 0; var6 < var5; ++var6) {
            ...
            if (parameter.equalsIgnoreCase("info")) {
                messenger.sendMessage(TextFormatting.GOLD + "Blend Disc Brush Parameters:");
                messenger.sendMessage(TextFormatting.AQUA + "/b bd water -- Toggles include or exclude (default) water.");
                return;
            }
        }
